...
- [ ] Define operator handling for terminal Slack-delivery failures and exhausted outbox items.
...
1. Define terminal-delivery and exhausted-outbox operator policy.
